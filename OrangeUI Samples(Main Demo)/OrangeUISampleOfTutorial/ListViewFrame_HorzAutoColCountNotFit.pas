...
unit ListViewFrame_HorzAutoColCountNotFit;
...
type
  TFrameListView_HorzAutoColCountNotFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_HorzAutoColCountNotFit.ChangeLanguage(
  ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_HorzAutoColCountNotFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_HorzAutoColCountNotFit.lbLightsClickItem(
  AItem: TSkinItem);
begin
