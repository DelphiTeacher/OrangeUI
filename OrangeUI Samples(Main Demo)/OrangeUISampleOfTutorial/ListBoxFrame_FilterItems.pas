...
type
  TFrameListBox_FilterItems = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListBox_FilterItems.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListBox_FilterItems.Create(AOwner: TComponent);
begin
  inherited;
