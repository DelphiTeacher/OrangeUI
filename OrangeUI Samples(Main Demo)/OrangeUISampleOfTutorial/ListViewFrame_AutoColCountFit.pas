...
unit ListViewFrame_AutoColCountFit;
...
type
  TFrameListView_AutoColCountFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_AutoColCountFit.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_AutoColCountFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_AutoColCountFit.lbLightsClickItem(
  AItem: TSkinItem);
begin
