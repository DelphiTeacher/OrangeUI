...
unit ListViewFrame_HorzAutoColCountFit;
...
type
  TFrameListView_HorzAutoColCountFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_HorzAutoColCountFit.ChangeLanguage(
  ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_HorzAutoColCountFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_HorzAutoColCountFit.lbLightsClickItem(
  AItem: TSkinItem);
begin
