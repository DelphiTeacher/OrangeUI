...
unit ListViewFrame_HorzSelectionStyle;
...
uses
  ...
  uSkinFireMonkeyListView, uSkinFireMonkeyItemDesignerPanel, uSkinFireMonkeyLabel,
...
type
  TFrameListView_HorzSelectionStyle = class(TFrame,IFrameChangeLanguageEvent)
...
{ TFrameListView_HorzSelectionStyle }

procedure TFrameListView_HorzSelectionStyle.ChangeLanguage(ALangKind: TLangKind);
begin
//  //翻译
...
constructor TFrameListView_HorzSelectionStyle.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_HorzSelectionStyle.DoFilter;
//var
//  I: Integer;
//  AFilter:String;
...
procedure TFrameListView_HorzSelectionStyle.edtFilterChange(Sender: TObject);
begin
  DoFilter;
end;

procedure TFrameListView_HorzSelectionStyle.edtFilterChangeTracking(Sender: TObject);
begin
  DoFilter;
end;

procedure TFrameListView_HorzSelectionStyle.edtFilterKeyUp(Sender: TObject;
