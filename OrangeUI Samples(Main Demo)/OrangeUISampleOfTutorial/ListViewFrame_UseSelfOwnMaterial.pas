...
unit ListViewFrame_UseSelfOwnMaterial;
...
type
  TFrameListView_UseSelfOwnMaterial = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_UseSelfOwnMaterial.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_UseSelfOwnMaterial.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_UseSelfOwnMaterial.lbLightsClickItem(AItem: TSkinItem);
begin
