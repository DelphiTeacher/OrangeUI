...
unit ListViewFrame_HorzFixColCountNotFit;
...
type
  TFrameListView_HorzFixColCountNotFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_HorzFixColCountNotFit.ChangeLanguage(
  ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_HorzFixColCountNotFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_HorzFixColCountNotFit.lbLightsClickItem(AItem: TSkinItem);
begin
