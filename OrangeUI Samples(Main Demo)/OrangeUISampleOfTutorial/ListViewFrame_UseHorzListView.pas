...
unit ListViewFrame_UseHorzListView;
...
type
  TFrameListView_UseHorzListView = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_UseHorzListView.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_UseHorzListView.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_UseHorzListView.lbLightsClickItem(AItem: TSkinItem);
begin
