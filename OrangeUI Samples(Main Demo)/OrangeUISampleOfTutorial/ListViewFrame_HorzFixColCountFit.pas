...
unit ListViewFrame_HorzFixColCountFit;
...
type
  TFrameListView_HorzFixColCountFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_HorzFixColCountFit.ChangeLanguage(
  ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_HorzFixColCountFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_HorzFixColCountFit.lbLightsClickItem(
  AItem: TSkinItem);
begin
