...
unit ListViewFrame_FixColCountNotFit;
...
type
  TFrameListView_FixColCountNotFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_FixColCountNotFit.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_FixColCountNotFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_FixColCountNotFit.lbLightsClickItem(AItem: TSkinItem);
begin
