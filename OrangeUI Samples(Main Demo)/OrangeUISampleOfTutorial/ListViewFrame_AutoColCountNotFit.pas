...
unit ListViewFrame_AutoColCountNotFit;
...
type
  TFrameListView_AutoColCountNotFit = class(TFrame,IFrameChangeLanguageEvent)
...
procedure TFrameListView_AutoColCountNotFit.ChangeLanguage(
  ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_AutoColCountNotFit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameListView_AutoColCountNotFit.lbLightsClickItem(
  AItem: TSkinItem);
begin
