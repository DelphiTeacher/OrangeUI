...
unit ListViewFrame_ItemDesignerPanel_9BoxMenu;
...
type
  TFrameListView_ItemDesignerPanel_9BoxMenu = class(TFrame,IFrameChangeLanguageEvent)
...
{ TFrameListView_9BoxMenu }

procedure TFrameListView_ItemDesignerPanel_9BoxMenu.ChangeLanguage(ALangKind: TLangKind);
begin
  //翻译
...
constructor TFrameListView_ItemDesignerPanel_9BoxMenu.Create(AOwner: TComponent);
begin
  inherited;
  //初始多语言
