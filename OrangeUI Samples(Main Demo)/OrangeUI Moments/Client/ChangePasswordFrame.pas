...
begin
  ...
  GetGlobalTimerThread.RunTempTask(DoChangePasswordExecute,DoChangePasswordExecuteEnd);
end;
...
begin
  try
    ...
    TTimerTask(ATimerTask).TaskDesc:=ClientModuleUnit1.ClientModule.ServerMethods1Client.ChangePassword(
