...
uses
  ...
  uSkinSwitchPageListPanelType, uSkinButtonType, uSkinImageType;
...
begin
  //显示发现界面
  ShowFrame(TFrame(GlobalMobileFindFrame),TFrameMobileFind,tsFind,nil,nil,nil,Application,False,True,ufsefNone);
...
begin
  //显示首页界面
  ShowFrame(TFrame(GlobalMobileHomeFrame),TFrameMobileHome,tsHome,nil,nil,nil,Application,False,True,ufsefNone);
...
begin
  //显示消息界面
  ShowFrame(TFrame(GlobalMobileMsgFrame),TFrameMobileMsg,tsMsg,nil,nil,nil,Application,False,True,ufsefNone);
...
begin
  //显示设置界面
  ShowFrame(TFrame(GlobalMobileMyFrame),TFrameMobileMy,tsMy,nil,nil,nil,Application,False,True,ufsefNone);
