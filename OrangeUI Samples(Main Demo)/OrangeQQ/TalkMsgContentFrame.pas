...
begin
  ...
  begin
    ...
    Self.btnContent.RefMaterial:=QQCommonSkinMaterialDataModule.bdmTalkMsg_Content_MyTextMsg;
  end
  else
  begin
    //别人发的消息
    Self.imgHead.Left:=Const_Default_HorzGap;
    Self.btnContent.RefMaterial:=QQCommonSkinMaterialDataModule.bdmTalkMsg_Content_YourTextMsg;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        //正在加载的图片
        AContentImage.Prop.Picture.SkinImageList:=QQCommonSkinMaterialDataModule.imglistDownloadState;
    ...
    begin
      ...
      AContentLabel.RefMaterial:=QQCommonSkinMaterialDataModule.ldmTalkMsg_Content_Default;
