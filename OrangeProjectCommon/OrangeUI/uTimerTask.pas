      ...
      try
          ...
          begin
              try
                ...
                on E:Exception do
                begin
                  uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecute'+' TaskName:'+ATimerTask.TaskName);
                end;
              end;
          end;
      finally
...
//              uBaseLog.HandleException(nil,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecuteEnd Begin TaskName:'+ATimerTask.TaskName);
              try
                  try
                    ...
                    on E:Exception do
                    begin
                      uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecuteEnd'+' TaskName:'+ATimerTask.TaskName);
                    end;
                  end;
              finally
...
begin
  try
    ...
    on E:Exception do
    begin
      uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.SetTaskObject');
    end;
  end;
end;
...
begin
  try
    ...
    on E:Exception do
    begin
      uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.SetTaskObject1');
    end;
  end;
end;
