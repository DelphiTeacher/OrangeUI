...
//      begin
//        //数据库连接失败或异常
//        ADesc:='查询字段时'+Trans('数据库连接失败或异常')+' '+ASQLDBHelper.LastExceptMessage;
//        Exit;
//      end;
//
//
...
//      begin
//        //数据库连接失败或异常
//        ADesc:='复制数据时'+Trans('数据库连接失败或异常')+' '+ASQLDBHelper.LastExceptMessage;
//        Exit;
//      end;
//
//
...
//  uBaseLog.HandleException(nil,'TTableDataSyncTask.SyncData Begin');
  ...
  try
          ...
          begin
            //数据库连接失败或异常
            ADesc:='获取源表数据时,'+Trans('数据库连接失败或异常')+' '+ASrcDBHelper.LastExceptMessage;
            Exit;
          end;
          ...
          begin
            //数据库连接失败或异常
            ADesc:='获取目标表数据时,'+Trans('数据库连接失败或异常')+' '+ADestDBHelper.LastExceptMessage;
            Exit;
          end;
...
//                  begin
//                    //数据库连接失败或异常
//                    ADesc:='添加目标表数据时,'+Trans('数据库连接失败或异常')+' '+ADestDBHelper.LastExceptMessage;
//                    Exit;
//                  end;
...
//                        AParamValues[I]:=ASrcDBHelper.Query.FieldByName(FieldMapList[I].SrcField).AsVariant;
                        if ADestDBHelper.Query.FieldByName(FieldMapList[I].DestField).AsVariant<>ASrcDBHelper.Query.FieldByName(FieldMapList[I].SrcField).AsVariant then
                        begin
