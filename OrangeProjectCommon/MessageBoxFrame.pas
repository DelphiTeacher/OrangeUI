...
uses
  ...
  uBaseSkinControl, uSkinPanelType, FMX.Controls.Presentation, FMX.Edit;
...
//                                  var AIsCanModalResult:Boolean) of object;
  ...
  TFrameMessageBox = class(TFrame,
    ...
    pnlInput1: TSkinFMXPanel;
    btnDec1: TSkinFMXButton;
    edtInput1: TSkinFMXEdit;
    btnInc1: TSkinFMXButton;
    pnlInput2: TSkinFMXPanel;
    btnDec2: TSkinFMXButton;
    edtInput2: TSkinFMXEdit;
    btnInc2: TSkinFMXButton;
...
//    procedure tmrBringToFrontTimer(Sender: TObject);
  ...
  private
    ...
    procedure ProcessButtonMaterial(AButton:TSkinFMXButton;
                                    AIsDefault:Boolean//;
...
procedure ShowMessageBoxFrame(
            ...
            const AMsg:String;
            const AOtherMsg: string='';
            AOnModalResult:TNotifyEvent=nil);overload;
{$ENDIF}
...
procedure ShowMessageBoxFrame(//显示在哪个控件上
                      ...
                      const AMsg:String;
                      const AOtherMsg: string;
                      AOnModalResult:TNotifyEvent);overload;
begin
...
begin
  ...
  begin
    Self.btnButton1.Width:=(Self.pnlMessageBox.Width-Self.pnlButtonDevide.Width)/2;
    Self.btnButton2.Width:=(Self.pnlMessageBox.Width-Self.pnlButtonDevide.Width)/2+1;
  end;
...
function TFrameMessageBox.GetVirtualKeyboardHeightAdjustHeight: Double;
begin
  Result:=0;
end;
...
procedure TFrameMessageBox.ProcessButtonMaterial(AButton: TSkinFMXButton;
                                    AIsDefault:Boolean//;
//                                    AIsTwoButton:Boolean
                                    );
begin
...
//      end;
  ...
  AMessageBoxHeight:=Self.pnlTop.HeightInt+Self.pnlBottom.Height;
  ...
  if (AMsg<>'') then
  begin
      Self.lblCaption.Height:=CalcStringHeight(AMsg,
                Self.lblCaption.WidthInt,//RectF(0,0,Self.lblCaption.WidthInt,1000),
