...
type
  ...
  public
    procedure ShowHint(AParent:TFmxObject;AHint:String;AChangeOpacityInterval:Integer=100);
    { Public declarations }
  end;
...
procedure ShowHintFrame(AParent:TFmxObject;AHint:String;AChangeOpacityInterval:Integer=100);
...
procedure ShowHintFrame(AParent:TFmxObject;AHint:String;AChangeOpacityInterval:Integer);
{$IFDEF ANDROID}
var
  LStr: JString;
{$ENDIF}
...
procedure TFrameHint.ShowHint(AParent:TFmxObject;AHint:String;AChangeOpacityInterval:Integer);
begin
...
//      end;
  ...
  Self.Position.Y:=GetControlParentHeight(AParent)-Height-80;
