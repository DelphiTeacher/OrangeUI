...
//  TBaseNewSkinControl=TBaseFMXControl;
  ...
  TBaseSkinControl=TSkinFireMonkeyControl;
...
//end;
//
//function TBaseFMXControl.LoadFromFieldControlSetting(ASetting:TFieldControlSetting):Boolean;
//begin
//  Result:=True;
//end;
//
