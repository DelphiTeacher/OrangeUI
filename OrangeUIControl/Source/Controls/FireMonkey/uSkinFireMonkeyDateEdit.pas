...
function TSkinFMXCustomDateEdit.LoadFromFieldControlSetting(ASetting:TFieldControlSetting;AFieldControlSettingMap:TObject):Boolean;
begin
...
//
//end;
procedure TSkinFMXCustomDateEdit.DoReturnFrame(AFromFrame:TFrame);
begin
