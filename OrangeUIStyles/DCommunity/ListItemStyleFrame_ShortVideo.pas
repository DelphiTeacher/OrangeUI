...
unit ListItemStyleFrame_ShortVideo;
...
type
  TFrameShortVideoListItemStyle = class(TFrameBaseListItemStyle,IFrameBaseListItemStyle)
    ...
    SpacePanel: TSkinFMXPanel;
    imglistGenderIcon: TSkinImageList;
    SkinFMXPanel2: TSkinFMXPanel;
    imgItemPlay: TSkinFMXImage;
    imgItemGender: TSkinFMXImage;
    lblItemTimeLong: TSkinFMXLabel;
    lblItemDetail: TSkinFMXLabel;
    SkinFMXButton2_Material: TSkinButtonDefaultMaterial;
...
constructor TFrameShortVideoListItemStyle.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TFrameShortVideoListItemStyle.ItemDesignerPanelPrepareDrawItem(
...
var
  StrLength:Double;
var
//  AListStyleFrame:TFrameDelphiContentListItemStyle;
  I: Integer;
...
//      StrLength:=GetStringWidth(AFrameShortVideoListItemStyle.lblItemDetail.Caption,14)+5;
////      if StrLength>=GetStringWidth('字',14)*6 then  StrLength:=GetStringWidth('字',14)*6-1;
//      AFrameShortVideoListItemStyle.lblItemDetail.Width:=Ceil(StrLength);
//      AFrameShortVideoListItemStyle.imgItemGender.Position.X:=Ceil(StrLength);
//
//
//
//
...
//  end;
      ...
      StrLength:=GetStringWidth(Self.lblItemDetail.Caption,14)+5;
//      if StrLength>=GetStringWidth('字',14)*6 then  StrLength:=GetStringWidth('字',14)*6-1;
      Self.lblItemDetail.Width:=Ceil(StrLength);
      Self.imgItemGender.Position.X:=Ceil(StrLength);



end;

procedure TFrameShortVideoListItemStyle.lbCommentListGetItemBufferCacheTag(
...
initialization
  RegisterListItemStyle('ShortVideo',TFrameShortVideoListItemStyle,270,False);


finalization
  UnRegisterListItemStyle(TFrameShortVideoListItemStyle);
