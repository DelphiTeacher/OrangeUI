...
unit ListItemStyleFrame_CaptionTop_DetailBottom_Detail1Button;
...
type
  TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button = class(TFrame,IFrameBaseListItemStyle)
...
constructor TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button.Create(AOwner: TComponent);
begin
  inherited;
...
function TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button.GetItemDesignerPanel: TSkinItemDesignerPanel;
begin
  Result:=ItemDesignerPanel;
end;

procedure TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button.ItemDesignerPanelPrepareDrawItem(
...
initialization
  RegisterListItemStyle('CaptionTop_DetailBottom_Detail1Button',TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button);

finalization
  UnRegisterListItemStyle(TFrameListItemStyle_CaptionTop_DetailBottom_Detail1Button);
