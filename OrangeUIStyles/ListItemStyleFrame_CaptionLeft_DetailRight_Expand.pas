...
unit ListItemStyleFrame_CaptionLeft_DetailRight_Expand;
...
type
  TFrameListItemStyle_CaptionLeft_DetailRight_Expand = class(TFrame,IFrameBaseListItemStyle)
...
constructor TFrameListItemStyle_CaptionLeft_DetailRight_Expand.Create(AOwner: TComponent);
begin
  inherited;
...
function TFrameListItemStyle_CaptionLeft_DetailRight_Expand.GetItemDesignerPanel: TSkinItemDesignerPanel;
begin
  Result:=ItemDesignerPanel;
end;

procedure TFrameListItemStyle_CaptionLeft_DetailRight_Expand.ItemDesignerPanelPrepareDrawItem(
...
begin
  ...
  if Self.imgExpand.Visible then
  begin
    AItemDetailDrawRect.Right:=AItemDetailDrawRect.Right-imgExpand.Width;
  end;
...
initialization
  RegisterListItemStyle('CaptionLeft_DetailRight_Expand',TFrameListItemStyle_CaptionLeft_DetailRight_Expand);

finalization
  UnRegisterListItemStyle(TFrameListItemStyle_CaptionLeft_DetailRight_Expand);
