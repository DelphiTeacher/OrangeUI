unit ListItemStyleFrame_ScoreRecharge;
...
type
  TFrameListItemStyle_ScoreRecharge = class(TFrame,IFrameBaseListItemStyle)
...
function TFrameListItemStyle_ScoreRecharge.GetItemDesignerPanel: TSkinItemDesignerPanel;
begin
...
initialization
  RegisterListItemStyle('ScoreRecharge',TFrameListItemStyle_ScoreRecharge);

finalization
  UnRegisterListItemStyle(TFrameListItemStyle_ScoreRecharge);
