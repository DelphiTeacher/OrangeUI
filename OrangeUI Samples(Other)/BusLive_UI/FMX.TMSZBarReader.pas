...
{$IFDEF IOS}
{$O-}
function lzld: ZBarReaderViewController; cdecl; external 'ZBarSDK\libzbar.a' name 'OBJC_CLASS_$_ZBarReaderViewController';
{$O+}
function zbar_symbol_set_first_symbol(symbols : zbar_symbol_set_t): zbar_symbol_t; cdecl; external 'ZBarSDK\libzbar.a' name 'zbar_symbol_set_first_symbol';
{$ENDIF}
