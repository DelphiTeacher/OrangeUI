...
uses
  ...
  uSkinLabelType, uSkinImageListViewerType, uSkinItemDesignerPanelType,
  uSkinScrollControlType, uSkinCustomListType, uSkinVirtualListType,
  uSkinImageType, uBaseSkinControl, uSkinPanelType, uDrawCanvas;
...
//  Self.lbHome.VertScrollBar.Properties.ControlGestureManager.IsNeedDecideFirstGestureKind:=True;
