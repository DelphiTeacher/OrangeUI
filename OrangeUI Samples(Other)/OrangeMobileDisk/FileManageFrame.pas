...
type
  TFrameFileManage = class(TFrame)
    ...
    procedure lbFileListPrepareDrawItem(Sender: TObject; Canvas: TDrawCanvas;
      ...
      ItemRect: TRect);
    procedure lbFileListSelectedItem(Sender: TObject;AItem:TSkinItem);
    ...
    procedure lbFileListClickItem(Sender: TSkinItem);
...
procedure TFrameFileManage.lbFileListClickItem(Sender: TSkinItem);
var
  AFileItem:TFileItem;
begin
  //查看文件
  ...
  begin
    ...
    case FileItem.FileType of
      ...
      begin
        ...
        Self.lblFileSize.Caption:=GetFileSizeStr(FileItem.Size);
      end;
    end;
...
procedure TFrameFileManage.lbFileListSelectedItem(Sender: TObject;AItem:TSkinItem);
var
  AFileItem:TFileItem;
begin
  //查看文件
